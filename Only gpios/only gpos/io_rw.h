...
//write macro
//#define io_write(base_addr, offset, data)   ( *(volatile uint32_t *) ( (base_addr) + ((offset)<< 2) )  = (data) )
#define io_write(base_addr, offset, data)   ( *(volatile uint32_t *) ( (base_addr) + ((offset) * 4) )  = (data) )
//slot addr macro
